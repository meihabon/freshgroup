...
import { Row, Col, Card, Spinner, Alert, Modal, Table, Tabs, Tab } from 'react-bootstrap'
  ...
  <div className="fade-in">
    <div className="mb-4">
      ...
      <p className="text-muted">
        A comprehensive overview of student demographics and performance indicators.
      </p>
    </div>
        ...
        <Card className="mb-4 shadow-sm border-0">
          <Card.Body>
            ...
            <p className="text-muted">
              ...
              student support services, and institutional accreditation.
            </p>
            <Row>
              <Col md={6}>
                <ul>
                  <li><b>Income:</b> Helps target scholarships and equity programs.</li>
                  <li><b>Sex:</b> Enables gender-sensitive student programs.</li>
                  <li><b>Program:</b> Identifies in-demand courses for resource allocation.</li>
                </ul>
              </Col>
              <Col md={6}>
                <ul>
                  <li><b>Municipality:</b> Supports regional outreach and inclusivity.</li>
                  <li><b>SHS Type:</b> Reveals academic preparation differences.</li>
                  <li><b>Honors:</b> Recognizes academic achievers for scholarships.</li>
                </ul>
              </Col>
            </Row>
          </Card.Body>
